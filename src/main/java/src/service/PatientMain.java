                ...
                case 1:
                    ...
                    while (true) {
                        ...
                        if (!contact.matches("[6-9]\\d{9}")) {
                            System.out.println("\u001B[31mEnter a valid 10-digit contact number starting with 6, 7, 8, or 9.\u001B[0m");
                            continue;
                        }

                        // Check: not all digits same (e.g., 9999999999)
                        if (contact.matches("(\\d)\\1{9}")) {
                            System.out.println("\u001B[31mAll digits should not be the same.\u001B[0m");
                            continue;
                        }

                        // Check: no digit appears more than 7 times
                        boolean repeatedTooMuch = false;
                        ...
                        if (repeatedTooMuch) {
                            System.out.println("\u001B[31mNo digit should appear more than 7 times.\u001B[0m");
                            continue;
                        }
                    ...
                    while (true) {
                        ...
                        // Split to check if local part equals domain (e.g., abc@abc.com)
                        String[] parts = email.split("@");
                        if (parts.length == 2) {
                            String local = parts[0];
                            String domain = parts[1].split("\\.")[0];
                            if (local.equalsIgnoreCase(domain)) {
                                System.out.println("\u001B[31mEmail local part and domain should not be the same!\u001B[0m");
                                continue;
                            }
                        }
                    ...
                    while (true) {
                        ...
                        if (address.length() <= 20) {
                            System.out.println("\u001B[31mAddress must be more than 20 characters.\u001B[0m");
                            continue;
                        }

                        // Check if address is only numbers
                        if (address.matches("\\d+")) {
                            System.out.println("\u001B[31mAddress cannot be all numbers.\u001B[0m");
                            continue;
                        }

                        // Check valid characters and length limit
                        if (!address.matches("^[A-Z0-9, /-]{4,200}$")) {
                            System.out.println("\u001B[31mAddress contains invalid characters.\u001B[0m");
                            continue;
                        }
